...
uv pip install -q transformers==4.51.3 accelerate==1.5.2 peft==0.19.1 trl==0.16.0 datasets==3.5.0 sentence-transformers==3.4.1 pyarrow==19.0.1 openpyxl pandas tensorboard webcolors
